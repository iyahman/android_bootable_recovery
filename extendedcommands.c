...
int show_advanced_menu()
{
    ...
    static char* list[MAX_NUM_MANAGED_VOLUMES + 12];
    ...
    memset(list, 0, MAX_NUM_MANAGED_VOLUMES + 12);
    ...
    list[5] = "key test";
    list[6] = "show log";
    list[7] = "Clear init.d directory";
    list[8] = "Clear NSTools settings";
    list[9] = "Clear Semaphore Manager settings";
    ...
    for (;;)
    {
	    ...
	    case 10:
            ...
            default:
                if (chosen_item >= 11) {
                    partition_sdcard(list[chosen_item] + 13);
                }
                break;
        }
    }
